...
-- Full employee profile in one flat row per employee.
-- Includes position, department, employment status, current
-- address, latest compensation, supervisor name, and all four
-- government ID numbers pivoted into columns.
-- Based on Gemini's suggestion — fixed GROUP BY for strict mode
-- and added supervisor + missing name fields.
-- -------------------------------------------------------------
