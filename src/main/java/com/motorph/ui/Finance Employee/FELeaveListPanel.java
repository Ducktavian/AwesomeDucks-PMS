...
public class FELeaveListPanel extends JPanel {
    ...
    private void addSearchArea() {
        ...
        LightDropdown leaveDropdown = new LightDropdown("Leave");
        leaveDropdown.setBounds(79, 159, 107, 36);
        add(leaveDropdown);
    ...
    private void addLeaveTable() {
        LeaveTable table = new LeaveTable();
        table.setBounds(79, 218, 864, 405);
        add(table);
    }

    private static class LeaveTable extends JComponent {

        private final LeaveRow[] rows = {
                new LeaveRow("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "", "Pending"),
                new LeaveRow("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "", "Rejected"),
                new LeaveRow("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "", "Approved"),
                new LeaveRow("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "", "Pending"),
                new LeaveRow("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "", "Rejected"),
                new LeaveRow("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "", "Approved"),
                new LeaveRow("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "", "Pending")
        ...
        private void drawHeader(Graphics2D g2) {
            ...
            g2.drawString("Name", 18, 12);
            g2.drawString("Department", 115, 12);
            g2.drawString("Date", 233, 12);
            g2.drawString("Start Time", 363, 12);
            g2.drawString("End Time", 466, 12);
            g2.drawString("Reason", 559, 12);
            g2.drawString("Notes", 670, 12);
            g2.drawString("Status", 772, 12);
        ...
        private void drawRows(Graphics2D g2) {
            ...
            for (int i = 0; i < rows.length; i++) {
                ...
                g2.drawString(row.notes, 670, y + 13);
