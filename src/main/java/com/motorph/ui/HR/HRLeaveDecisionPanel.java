...
public class HRLeaveDecisionPanel extends JPanel {
    ...
    private final RoundedTextField leaveIdField;
    ...
    public HRLeaveDecisionPanel() {
        this(null, null, null);
    }

    public HRLeaveDecisionPanel(Runnable onBack, Runnable onApprove, Runnable onReject) {
        ...
        leaveIdField = addTextField("Leave ID", 63, 215, 408, 57);
        ...
        reasonField = addDropdownField("Reason", 539, 216, 404, 57);
        notesArea = addTextArea("Notes", 539, 329, 404, 168);
        statusField = addDropdownField("Status", 539, 551, 404, 57);
