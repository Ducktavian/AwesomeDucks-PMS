...
public class HREmployeesList extends JFrame {
    ...
    public HREmployeesList() {
        setTitle("MotorPH HR Employees List");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setResizable(false);

        setContentPane(new EmployeesRootPanel());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            HREmployeesList page = new HREmployeesList();
            page.setVisible(true);
        });
    }

    private static class EmployeesRootPanel extends JPanel {

        public EmployeesRootPanel() {
            ...
            dropdown.setBounds(335, 152, 108, 36);
            add(dropdown);
            ...
            EmployeesTablePanel table = new EmployeesTablePanel();
            table.setBounds(335, 219, 865, 500);
            add(table);
        }
    }
    ...
    private static class ActionButton extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            switch (icon) {
                case ADD -> drawAdd(g2);
                case UPDATE -> drawUpdate(g2);
                case DELETE -> drawDelete(g2);
        ...
        private void drawAdd(Graphics2D g2) {
            g2.drawLine(24, 12, 24, 25);
            g2.drawLine(17, 18, 31, 18);
        }
        ...
        private void drawUpdate(Graphics2D g2) {
            ...
            g2.drawLine(28, 10, 32, 14);
            g2.drawLine(18, 24, 24, 22);
        }
        ...
        private void drawRefresh(Graphics2D g2) {
            Arc2D arc = new Arc2D.Double(18, 10, 15, 15, 40, 280, Arc2D.OPEN);
            g2.draw(arc);
    ...
    private static class EmployeesTablePanel extends JPanel {
        ...
        private void drawHeader(Graphics2D g2) {
            ...
            g2.drawString("Employee No.", 20, 18);
            g2.drawString("Name", 147, 18);
            g2.drawString("Status", 287, 18);
            g2.drawString("Position", 447, 18);

            g2.drawString("Immediate", 605, 10);
            g2.drawString("Supervisor", 605, 28);

            g2.drawString("Role", 743, 18);

            g2.fillRect(3, 52, 859, 3);
        }

        private void drawRows(Graphics2D g2) {
            g2.setColor(ROW_GRAY);

            g2.fillRect(3, 111, 862, 55);
            g2.fillRect(0, 221, 865, 57);
            g2.fillRect(3, 331, 862, 50);
            g2.fillRect(0, 434, 865, 56);
        }
    }
