...
public class HREUTOTListPanel extends JPanel {
    ...
    private JComponent createTypeDropdown() {
        DropdownInput input = new DropdownInput("UT/OT");
    ...
    private JComponent createRequestTable() {
        ...
        table.add(createHeader("Type", 669, 0, 70));
        ...
        records.add(new RequestRecord("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "Undertime", "Pending"));
        records.add(new RequestRecord("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "Overtime", "Rejected"));
        records.add(new RequestRecord("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "Undertime", "Approved"));
        records.add(new RequestRecord("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "Undertime", "Pending"));
        records.add(new RequestRecord("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "Undertime", "Rejected"));
        records.add(new RequestRecord("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "Overtime", "Approved"));
        records.add(new RequestRecord("Juan Cruz", "IT", "September 1, 2026", "5:00 PM", "6:00 PM", "Undermanned", "Overtime", "Pending"));
        ...
        for (int i = 0; i < records.size(); i++) {
            RequestRow row = new RequestRow(records.get(i), i % 2 == 1);
    ...
    private static class RequestRow extends JPanel {

        public RequestRow(RequestRecord record, boolean shaded) {
            setLayout(null);
            setOpaque(true);
            ...
            add(createCell(record.type, 669, 14, 80));
